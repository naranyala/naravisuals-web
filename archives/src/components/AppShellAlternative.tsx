  ...
  return (
    <div class={s.codeWrapper}>
      <div class={s.codeHeader}>
        ...
        <button
          class={clsx(s.copyBtn, copied.value && 'copied')}
          onClick={copyCode}
        >
          {copied.value ? (
            <>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const article = computed(() =>
      props.articles.find((a) => a.id === selected.value),
    );
    ...
    watch(article, async (art) => {
      ...
      codeBlocks.value = Array.from(doc.querySelectorAll('pre > code')).map(
        (code) => ({
      ...
      <div class={s.app}>
        ...
        {article.value && (
          <div
            class={s.modal}
            onClick={(e) =>
              e.target === e.currentTarget && (selected.value = null)
            }
          >
            <div class={s.reader}>
              <div class={s.header}>
                <button class={s.btn} onClick={() => (selected.value = null)}>
                  ← Back
                </button>
