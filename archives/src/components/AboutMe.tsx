  ...
  setup() {
    ...
    const resumeData = {
      personal: {
        ...
        summary:
          'Frontend developer with 8+ years experience in Vue.js, React, and TypeScript. Passionate about performance optimization and clean code.',
      },
      experiences: [
        {
          ...
          endDate: 'Present',
          description:
            'Led development of customer-facing web apps using Vue.js and TypeScript. Improved performance by 40%.',
        ...
        },
        {
          ...
          endDate: '2020',
          description:
            'Built responsive web applications with React and Redux. Implemented pixel-perfect interfaces.',
                ...
                <div key={i} class={styles.experienceItem}>
                  <div class={styles.expHeader}>
                    <h4 class={styles.expTitle}>
                      {exp.title} •{' '}
                      <span class={styles.expCompany}>{exp.company}</span>
                    </h4>
                    <span class={styles.expDate}>
