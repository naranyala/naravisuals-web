...
export default defineComponent({
  ...
  setup() {
    ...
    function copyToClipboard() {
      ...
      navigator.clipboard
        .writeText(encodingResult.value)
        .then(() => {
    ...
    return () => (
      <div class={s.app}>
        <div class={s.headerContainer}>
          ...
          <p class={s.subtitle}>
            Upload images to convert them to Base64 format
          </p>
        </div>
          ...
          <div class={s.rightPanel}>
            <div class={s.outputSection}>
              <div class={s.outputHeader}>
                ...
                {encodingResult.value && (
                  <button
                    class={`${s.copyButton} copy-button`}
              ...
              {encodingResult.value ? (
                <div class={s.outputContent}>
                  <div class={s.stats}>
                    <span>
                      Length: {encodingResult.value.length} characters
                    </span>
                ...
                <div class={s.emptyState}>
                  ...
                  <div class={s.emptySubtext}>
                    Upload an image and click "Convert to Base64"
                  </div>
                </div>
              )}
