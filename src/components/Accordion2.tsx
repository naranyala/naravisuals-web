import { defineComponent, PropType, ref, provide, inject } from 'vue'
...
export const Accordion = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const isItemActive = (id: string) => {
      return props.multiple ? activeItems.value.has(id) : activeItem.value === id
    }
    ...
    return () => (
      <div class={['accordion', props.className]}>
        {slots.default?.()}
      </div>
    )
  }
