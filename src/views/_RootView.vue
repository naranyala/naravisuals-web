...
import ReferencesForLLM from "./ReferencesForLLM.vue"
import ReferencesForMath from "./ReferencesForMath.vue"
import ReferencesForPhysics from "./ReferencesForPhysics.vue"
import ReferencesForGame from "./ReferencesForGame.vue"

import DrivingCarExperience from "./three-js/DrivingCarExperience.vue"
import AnotherArticle from "./AnotherArticle.vue"

import SvgCreation01 from "./scalable_vector/SvgCreation01.vue"
...
import SvgCreationWrapper from "./SvgCreationWrapper.vue"

import DialogFlow from "./DialogFlow.vue"
...
const navSections = reactive([
  {
    title: 'general references', items: [
      ...
      { id: 113, label: 'dialog-flow', component: DialogFlow, isActive: false},
    ]
  },

  {
    title: 'canvas-exploration', items: [
      ...
      { id: 208, label: 'car-driving', component: DrivingCarExperience, isActive: false},
      { id: 209, label: 'goober-motion', component: GooberMotionWrapper, isActive: false},
      { id: 210, label: 'motion-svg', component: SvgCreationWrapper, isActive: false},
    ]
  },

  {
    title: 'audio-programming', items: [
      { id: 300, label: 'llm-references', component: ReferencesForLLM, isActive: false},
      { id: 301, label: 'math-references', component: ReferencesForMath, isActive: false},
      { id: 302, label: 'physics-references', component: ReferencesForPhysics, isActive: false},
      { id: 303, label: 'game-references', component: ReferencesForGame, isActive: false},
      { id: 304, label: 'academic-paper', component: AcademicPaper, isActive: false},
      { id: 305, label: 'articles', component: ArticleView, isActive: false},
      { id: 306, label: 'examples', component: CanvasEngineAudio, isActive: false},
    ]
  },
...

  {
    title: 'geo-and-maps', items: [
      { id: 400, label: 'geo-related', component: () => "WIP", isActive: false},
      { id: 401, label: 'map-related', component: () => "WIP", isActive: false},
    ]
  },
